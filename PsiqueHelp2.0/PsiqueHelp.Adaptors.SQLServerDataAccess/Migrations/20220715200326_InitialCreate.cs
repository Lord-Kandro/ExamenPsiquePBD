        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    created_at = table.Column<DateTime>(nullable: false),
                    updated_at = table.Column<DateTime>(nullable: false),
                    ConTer_id = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConTer_id = table.Column<Guid>(nullable: true),
                    Id_Login = table.Column<Guid>(nullable: false),
                    login_usersId_Login = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_tb_PsyDa_tb_LoginUsers_Id_User_Psy",
                        column: x => x.Id_User_Psy,
                        principalTable: "tb_LoginUsers",
                        principalColumn: "Id_Login",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_tb_PsyDa_tb_LoginUsers_login_usersId_Login",
                        column: x => x.login_usersId_Login,
                        principalTable: "tb_LoginUsers",
                        principalColumn: "Id_Login",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tb_UserDa_tb_LoginUsers_Id_UserDa",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id_UserDa = table.Column<Guid>(nullable: true),
                    Id_User_Psy = table.Column<Guid>(nullable: true),
                    created_at = table.Column<DateTime>(nullable: false),
                    updated_at = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tb_PsyDa_login_usersId_Login",
                table: "tb_PsyDa",
                column: "login_usersId_Login");
        }
