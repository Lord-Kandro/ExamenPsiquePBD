        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConTer_id = table.Column<Guid>(nullable: true),
                    Id_Login = table.Column<Guid>(nullable: true),
                    created_at = table.Column<DateTime>(nullable: false),
                    updated_at = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_tb_PsyDa_tb_LoginUsers_Id_Login",
                        column: x => x.Id_Login,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tb_UserDa_tb_LoginUsers_Id_Login",
                        column: x => x.Id_Login,
                        principalTable: "tb_LoginUsers",
                        principalColumn: "Id_Login",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tb_PsyDa_Id_Login",
                table: "tb_PsyDa",
                column: "Id_Login");

            migrationBuilder.CreateIndex(
                name: "IX_tb_UserDa_Id_Login",
                table: "tb_UserDa",
                column: "Id_Login");
        }
